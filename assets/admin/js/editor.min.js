;(function($) {
	...
	window.BdevsElementEditor = window.BdevsElementEditor || {
		i18n: {
			editorPanelHomeLinkTitle: 'Home',
			editorPanelWidgetsLinkTitle: 'Widgets'
		},
		editorPanelHomeLinkURL: '#',
		editorPanelWidgetsLinkURL: '#'
	};

	jQuery(window).on('elementor:init', function() {
	  elementor.on('panel:init', function() {
		jQuery('#elementor-panel-elements-search-input').on('keyup', _.debounce(function() {
		  jQuery('#elementor-panel-elements')
			.find('.hm')
