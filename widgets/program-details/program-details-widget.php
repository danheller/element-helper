...
class Program_Details extends Element_El_Widget {
	...
	public function get_title() {
		return __( 'Program Details', 'elementhelper' );
	}

	public function get_custom_help_url() {
		return 'http://elementor.sabber.com/ElementHelper/programDetails/';
	}
	...
	public function get_keywords() {
		return [ 'programDetails', 'blurb', 'infobox', 'content', 'block', 'box' ];
	}
	...
	protected function render() {
		...
		?>
        <div class="p-content-wrapper pl-25">
            <div class="row">
                <div class="col-xl-12">
                    <div class="p-undergraduate-wrap mb-25">
                        ...
                        <?php endif; ?>
                        <?php if(!empty($banner)): ?>
                            <div class="p-undergraduate-thumb">
            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="p-about-card-wrap mb-40">
	                    <?php if(!empty($image)): ?>
                            <div class="p-about-thumb">
